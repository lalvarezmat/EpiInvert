...
EpiIndicatorsC <- function(date, f, g, s_min = -25L, s_max = 25L, wr = 1000, ws = 10, tail = 0L, tail_mu = 0, r_init = -1e6, r_end = -1e6, s_init = -1e6, s_end = -1e6) {
    .Call(`_EpiInvert_EpiIndicatorsC`, date, f, g, s_min, s_max, wr, ws, tail, tail_mu, r_init, r_end, s_init, s_end)
}
