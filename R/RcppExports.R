...
EpiInvertForecastC <- function(i_original, i_restored, last_incidence_date, q_bias, i_restored_database, type, NumberForecastAdditionalDays = 0L) {
    .Call(`_EpiInvert_EpiInvertForecastC`, i_original, i_restored, last_incidence_date, q_bias, i_restored_database, type, NumberForecastAdditionalDays)
}
